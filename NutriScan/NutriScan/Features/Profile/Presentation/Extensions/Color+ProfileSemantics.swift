...
extension Color {
    struct ProfileSemantics {
        ...
        static let familyMembersContainerBackground = Color(light: .white, dark: Color.Teal.teal1500)

        static let sectionTitle = Color(light: Color.Teal.teal1000, dark: Color.Teal.teal500)
        ...
        static let editIcon = Color(light: .white, dark: Color.Teal.teal500)

        static let dashedBorder = Color.Teal.teal500
        ...
        static let addMemberIcon = Color(light: Color.Teal.teal1000, dark: Color.Teal.teal500)
        static let addMemberIconBackground = Color(light: .white, dark: Color.Teal.teal1500)

        static let memberCardBackground = Color(light: Color.Teal.teal100, dark: Color.Teal.teal1600)
        static let memberCardBorder = Color.Teal.teal1000
        static let memberName = Color(light: Color.Teal.teal1000, dark: Color.Teal.teal400)
    }
}
