...
struct LocalizationKeys {
    ...
    struct Settings {
        ...
        static let appearanceSystem: String.LocalizationValue = "settings.appearance_system"
        static let appearanceLight: String.LocalizationValue = "settings.appearance_light"
        static let appearanceDark: String.LocalizationValue = "settings.appearance_dark"
        static let language: String.LocalizationValue = "settings.language"
        static let languageEnglish: String.LocalizationValue = "settings.language_english"
        static let languageArabic: String.LocalizationValue = "settings.language_arabic"
